...
**Skills**: R Programming | Data Analysis | Data Cleaning | Data Wrangling | Data Preparation | Exploratory Data Analysis (EDA) | Statistical Analysis | Descriptive Statistics | Data Visualization | ggplot2 | Tidyverse (dplyr, tidyr) | Time Series & Date Analysis (lubridate) | Data Aggregation | Feature Engineering | Geospatial Analysis | Reproducible Reporting (R Markdown)
...
**Skills:** Python Programming | Statistical Analysis | Hypothesis Testing | Inferential Statistics | A/B Testing Concepts | Parametric & Non-Parametric Tests | t-Test | Chi-Square Test | Normality Testing | p-Value Interpretation | Confidence Intervals | Data Cleaning | Exploratory Data Analysis (EDA) | Pandas | NumPy | SciPy | Data-Driven Decision Making | Jupyter Notebook
...
## 4. Online Ratail Transactions Analysis
